...
<%@page import=" com.bridgeit.model.User ,java.util.ArrayList,java.util.List"%>
      ...
      <ul  class = "nav navbar-nav">
         ...
         <li class = "dropdown">
            <a href = "#" class = "dropdown-toggle" >
             ...
             <li class="user"><%=session.getAttribute("email") %>
         ...
         <h4 align="center"><%=session.getAttribute("email") %> </h4>
</body>
</html>